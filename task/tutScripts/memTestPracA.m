...
mem_filename = ['sub', int2str(subjectNumber), '_', date, '_mem_tutorialA.txt'];
...
freqReports_filename = ['sub', int2str(subjectNumber), '_', date, '_mem_freqReports_tutorialA.txt'];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 29:33
instructionPicName = ['tutInstructionsA/Slide', int2str(i), '.jpeg'];
