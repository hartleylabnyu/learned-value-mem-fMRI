...
% the previous two tasks. In this first part, each card will be presented
% once. 
%% Create data file for the main memory data
mem_filename = ['sub', int2str(subjectNumber), '_', date, '_mem2a_mri.txt'];
...
memInstructions = imread('taskInstructionsA/mem2_instructions.jpeg');
