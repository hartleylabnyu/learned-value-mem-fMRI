...
%% Create data file for memory data from subsequent appearances
mem_filename = ['sub', int2str(subjectNumber), '_', date, '_mem1b_mri.txt'];
...
memInstructions = imread('taskInstructionsA/mem1_part2_instructions.jpeg');
...
disp(['Trial ' int2str(trial) ' of  48 associative memory trials']);
