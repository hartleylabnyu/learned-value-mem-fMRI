%% Frequency Reports - Block 2
% In this task, participants will report the number of times they saw the
% stimulus. 


%% Freq reports data file
freqReports_filename = ['sub', int2str(subjectNumber), '_', date, '_mem2_freqReports_mri.txt'];
...
memInstructions = imread('taskInstructionsA/freqMem2_instructions.jpeg');
