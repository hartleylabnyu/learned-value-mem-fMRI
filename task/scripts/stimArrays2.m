%% Generate stimulus arrays used in all three tasks - Version A, block 2
...
if cbNumber == 1
    cardStim1 = dir('stim/pics_set1/*.jpg');
    cardStim2 = dir('stim/pics_set2/*.jpg');
else
    cardStim1 = dir('stim/pics_set2/*.jpg');
    cardStim2 = dir('stim/pics_set1/*.jpg');
end
...
stampStim=dir('stim/frames/*.jpg');
stampArray = {stampStim.name}; 

%Randomize order of stimulus arrays
stampOrder = randperm(numCards); %generate random stamp order
cardOrder = randperm(numCards); %generate random card order
...
%create a new memTest array where the postcards in the 4 condition are
%repeated 3 times
